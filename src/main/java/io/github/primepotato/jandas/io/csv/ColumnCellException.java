 ...
 * column getIndex, columnNames and line to be retrieved.
 * <p>
 * The dumpRow method allows the row in question to be printed to a
 * a PrintStream such as System.out
 */
public class ColumnCellException extends RuntimeException {

    private static final long serialVersionUID = 1L;

    /**
     * The getIndex of the column that threw the Exception
     */
     ...
     * @param columnIndex The getIndex of the column that threw the Exception
     ...
     */
    public ColumnCellException(Exception e, int columnIndex, long rowNumber, String[] columnNames, String[] line) {
    ...
    /**
     * Returns the getIndex of the column that threw the Exception
     */
    ...
    public void dumpRow(PrintStream out) {
        for (int i = 0; i < columnNames.length; i++) {
            ...
            try {
                ...
                out.println("Unable to getObject cell " + i + " of this line");
            }
        }
    }
}
