...
public class CashFlowReportWithIteration implements ReportBuilder {
    ...
    public CashFlowReportWithIteration setResults(CashFlowResults results) {

        this.results = results;
        return this;
    }

    public CashFlowReportWithIteration setCashFlows(Table cashFlows) {
    ...
    public CashFlowReportWithIteration setTradeService(TradeService tradeService) {

        this.tradeService = tradeService;
        return this;
    }

    public CashFlowReportWithIteration setMarketService(FxMarket marketService) {
    ...
    @Override
    public CashFlowReportWithIteration build() {
