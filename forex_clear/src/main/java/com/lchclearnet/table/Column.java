 ...
 * <p>
 * Columns can either exist on their own or be a part of a table. All the jandas in a single column is of a particular
 * type.
 */
public interface Column<T> extends Iterable<T>, Comparator<T> {
    ...
    /**
     * Returns true if the column has no jandas
     *
    ...
    /**
     * Returns a copy of the receiver with no jandas. The column name and type are the same.
     *
     ...
     * For example if you lead a column containing 2, 3, 4 by 1, you getObject a column containing 3, 4, NA.
     */
     ...
     * <p>
     * For example if you lag a column containing 2, 3, 4 by 1, you getObject a column containing NA, 2, 3
     */
    Column<T> lag(int n);
