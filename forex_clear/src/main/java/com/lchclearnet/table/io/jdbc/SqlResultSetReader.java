...
package com.lchclearnet.table.io.jdbc;
...
public class SqlResultSetReader {
     ...
     * When reading from a database, the db column type is automatically assigned to the associated table column type
     *
     * @param jdbc       an int representing a legal value from java.sql.types;
     * @param columnType a table column type
     */
