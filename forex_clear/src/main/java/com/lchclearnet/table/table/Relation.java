...
package com.lchclearnet.table.table;
...
import com.lchclearnet.table.column.strings.TextColumn;
import com.lchclearnet.table.column.times.TimeColumn;
import com.lchclearnet.table.io.string.DataFramePrinter;
...
/**
 * A tabular jandas structure like a table in a relational database, but not formally implementing the relational algebra
 */
public abstract class Relation {
     ...
     */
    public <T> T get(int r, int c) {
        Column<T> column = (Column<T>) column(c);
        return column.get(r);
    }
    ...
    public CurrencyColumn[] currencyColumns() {
        return columns().stream().filter(e -> e.type() == ColumnType.CURRENCY).toArray(CurrencyColumn[]::new);
    }

    public CurrencyPairColumn[] currencyPairColumns() {
        return columns().stream().filter(e -> e.type() == ColumnType.CURRENCYPAIR).toArray(CurrencyPairColumn[]::new);
    }
    ...
    public DateColumn dateColumn(String columnName) { return (DateColumn) column(columnName); }
    ...
    public StringColumn stringColumn(String columnName) { return (StringColumn) column(columnName); }
    ...
    public CurrencyColumn currencyColumn(int columnIndex) { return (CurrencyColumn) column(columnIndex); }

    public CurrencyColumn currencyColumn(String columnName) { return (CurrencyColumn) column(columnName); }

    public CurrencyPairColumn currencyPairColumn(int columnIndex) { return (CurrencyPairColumn) column(columnIndex); }
    
    public CurrencyPairColumn currencyPairColumn(String columnName) { return (CurrencyPairColumn) column(columnName); }

    public EnumColumn enumColumn(int columnIndex) { return (EnumColumn) column(columnIndex); }
    
    public EnumColumn enumColumn(String columnName) { return (EnumColumn) column(columnName); }
