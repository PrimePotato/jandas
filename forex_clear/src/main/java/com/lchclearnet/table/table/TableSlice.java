...
import com.lchclearnet.table.column.numbers.NumberColumn;
 ...
 * Requests for jandas are forwarded to the underlying table.
 * <p>
...
public class TableSlice extends Relation implements IntIterable {
    ...
    /**
     * Returns a 0 based int iterator for use with, for example, getObject(). When it returns 0 for the first row,
     * getObject will transform that to the 0th row in the selection, which may not be the 0th row in the underlying
     * table.
     */
    @Override
