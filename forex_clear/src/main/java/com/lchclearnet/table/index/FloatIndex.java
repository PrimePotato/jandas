...
import com.lchclearnet.table.column.numbers.FloatColumn;
...
public class FloatIndex {
    ...
    public Selection atMost(float value) {
        Selection selection = new BitmapBackedSelection();
        Float2ObjectSortedMap<IntArrayList> head = index.headMap(value + 0.000001f);  // we add 1 to getObject values equal
        // to the arg
