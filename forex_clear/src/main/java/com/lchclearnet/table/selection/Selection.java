...
package com.lchclearnet.table.selection;
...
public interface Selection extends IntIterable {
     ...
     * getObject(0) returns 4, getObject(1) returns 32, and getObject(2) returns 71
     * <p>
     * It can be useful if you need to iterate over the jandas, although there is also an iterator
     */
    int get(int i);
