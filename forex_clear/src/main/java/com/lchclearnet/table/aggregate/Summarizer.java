...
import com.lchclearnet.table.table.SelectionTableSliceGroup;
...
/**
 * Summarizes the jandas in a table, by applying functions to a subset of its columns.
 * <p>
 * How to use:
 * <p>
...
public class Summarizer {
     ...
     * @return A table containing a row of summarized jandas for each group in the table slice group
     */
