...
import com.lchclearnet.table.column.numbers.NumberColumnFormatter;
...
import static com.lchclearnet.table.column.dates.DateColumn.valueIsMissing;
...
public interface DateMapFunctions extends Column<LocalDate> {
     ...
     * you want monthly jandas but your source jandas is more than a year long and you don't want months from different
