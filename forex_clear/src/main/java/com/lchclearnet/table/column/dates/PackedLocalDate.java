...
import com.lchclearnet.table.column.numbers.IntColumnType;
...
import static com.lchclearnet.table.column.DateAndTimePredicates.*;
...
public class PackedLocalDate {
    ...
    public static short getYear(int date) {
        // getObject first two bytes, then convert to a short
