...
import static com.lchclearnet.table.column.ColumnType.STRING;
...
public class StringColumn extends AbstractColumn<String>
     ...
     * select a column of categorical jandas must be encoded as a list of columns, such that each column represents
     ...
     *
     * @return jandas as {@link IntArrayList}
     */
