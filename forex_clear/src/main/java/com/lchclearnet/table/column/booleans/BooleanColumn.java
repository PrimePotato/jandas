...
import com.lchclearnet.table.predicates.BytePredicate;
...
import static com.lchclearnet.table.column.ColumnType.BOOLEAN;
...
public class BooleanColumn extends AbstractColumn<Boolean> implements BooleanMapUtils, CategoricalColumn<Boolean>, BooleanFillers<BooleanColumn> {
    ...
    /**
     * Returns the value in row i as a byte (0, 1, or Byte.MIN_VALUE representing missing jandas)
     *
     * @param i the row number
     */
