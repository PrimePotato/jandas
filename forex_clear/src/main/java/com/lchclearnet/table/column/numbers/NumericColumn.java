...
import com.lchclearnet.table.aggregate.NumericAggregateFunction;
import com.lchclearnet.table.Column;
import com.lchclearnet.table.Table;
import com.lchclearnet.table.predicates.DoubleBiPredicate;
import com.lchclearnet.table.predicates.DoubleRangePredicate;
...
import static com.lchclearnet.table.aggregate.AggregateFunctions.*;
import static com.lchclearnet.table.column.numbers.NumberPredicates.isMissing;
import static com.lchclearnet.table.column.numbers.NumberPredicates.isNotMissing;
...
public interface NumericColumn<T> extends Column<T>, NumberMapFunctions, NumberFilters {
    ...
    /**
     * Summarizes the jandas in this column for all rows where the current value matches the selection criteria
     * <p>
     * Example:
