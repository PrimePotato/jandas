...
public class CurrencyPredicates {
    ...
    public final static IntPredicate isMissing = i -> i == CurrencyColumn.MISSING_VALUE;

    public final static IntPredicate isNotMissing = i -> i != CurrencyColumn.MISSING_VALUE;
