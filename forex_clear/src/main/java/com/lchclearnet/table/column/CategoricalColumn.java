 ...
 * <p>
 * The column jandas is generally discrete, however NumberColumn implements CategoricalColumn so that it can be used to
 ...
 * - etc
 * <p>
 * DateTimeColumn is not included. TimeColumn can be converted to ints without loss of jandas, so it does implement this
 * interface
 */
