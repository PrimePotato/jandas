 ...
 */
public class CurrencyPairPredicates {

    public final static IntPredicate isMissing = i -> i == CurrencyPairColumn.MISSING_VALUE;

    public final static IntPredicate isNotMissing = i -> i != CurrencyPairColumn.MISSING_VALUE;
