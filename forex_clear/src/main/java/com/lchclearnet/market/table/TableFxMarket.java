...
public class TableFxMarket implements FxMarket {

    private final Map<MarketDataType<SourceType>, MarketService> serviceContext;

    public TableFxMarket(final Iterable<DataType> mktDataTypes,
                         final Map<SourceType, Object> dataContext) {

        this.serviceContext = new HashMap<>();
        TableMarketServiceFactory mktFactory = new TableMarketServiceFactory();
